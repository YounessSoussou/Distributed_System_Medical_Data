...
public class FrequenceCardiaqueSensor implements Sensor {
    ...
    public FrequenceCardiaqueSensor() {
        this.topicName = "frequence cardiaque";
        this.sensorType = "FREQUENCECARDIAQUE";
        this.alertTopic="FrequenceCSensor";
        this.unit = "bpm";
    ...
    public void generateData(){
        ...
        this.temperatureValue=Math.random()*60+50;
        this.date=new Date();
    }
