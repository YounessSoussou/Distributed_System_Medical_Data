...
public class PressionArterielleDiastoliqueSensor implements Sensor {
    ...
    public PressionArterielleDiastoliqueSensor() {
        this.topicName = "pression artérielle diastolique";
        this.sensorType = "PRESSIONAD";
        this.alertTopic="PressionADSensor";
        this.unit = "mmHg";
    ...
    public void generateData(){
        ...
        this.temperatureValue=Math.random()*50+60;
        this.date=new Date();
    }
